...
Send a test webhook to the bridge. Use [jwt.io][] to generate the JWT using the minimal format ```{ "myRef": "INV007", "currency": { "code": "EUR"}, "amountBeforeFee": 4800, "to": { "account": { "iban": "IE69CPAY99119912121212" }}}```
```bash
